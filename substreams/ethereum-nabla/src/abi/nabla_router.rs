    ...
    pub mod functions {
        ...
        pub struct GetAmountOut {
            ...
            pub token_in_out: Vec<Vec<u8>>,
            pub token_prices: Vec<substreams::scalar::BigInt>,
        }
        impl GetAmountOut {
            const METHOD_ID: [u8; 4] = [112u8, 141u8, 77u8, 148u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct PoolByAsset {
            pub param0: Vec<u8>,
        }
        impl PoolByAsset {
            const METHOD_ID: [u8; 4] = [6u8, 222u8, 148u8, 216u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for PoolByAsset {
            const NAME: &'static str = "poolByAsset";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for PoolByAsset {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        pub struct RegisterPool {
            pub swap_pool: Vec<u8>,
        }
        impl RegisterPool {
            const METHOD_ID: [u8; 4] = [171u8, 217u8, 8u8, 70u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                ...
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.swap_pool),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for RegisterPool {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        impl SwapExactTokensForTokens {
            const METHOD_ID: [u8; 4] = [37u8, 145u8, 152u8, 227u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SwapExactTokensForTokensWithoutPriceFeedUpdate {
            pub amount_in: substreams::scalar::BigInt,
            pub amount_out_min: substreams::scalar::BigInt,
            pub token_in_out: Vec<Vec<u8>>,
            pub to: Vec<u8>,
        ...
        impl SwapExactTokensForTokensWithoutPriceFeedUpdate {
            const METHOD_ID: [u8; 4] = [193u8, 109u8, 114u8, 168u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        for SwapExactTokensForTokensWithoutPriceFeedUpdate {
            const NAME: &'static str = "swapExactTokensForTokensWithoutPriceFeedUpdate";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UnregisterPool {
            pub asset: Vec<u8>,
        }
        impl UnregisterPool {
            const METHOD_ID: [u8; 4] = [173u8, 166u8, 28u8, 195u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for UnregisterPool {
            const NAME: &'static str = "unregisterPool";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for UnregisterPool {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for SwapPoolRegistered {
            const NAME: &'static str = "SwapPoolRegistered";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SwapPoolUnregistered {
            pub sender: Vec<u8>,
            pub asset: Vec<u8>,
        }
        impl SwapPoolUnregistered {
            const TOPIC_ID: [u8; 32] = [
                125u8,
                137u8,
                53u8,
        ...
        impl substreams_ethereum::Event for SwapPoolUnregistered {
            const NAME: &'static str = "SwapPoolUnregistered";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
